...
# Arguments;
	...
	# psi <- a tuning parameter - here, some proportion of the standard deviation from the calibration step; -> Now the function is using 0.1 as a fixed value and not some proportion of the extinction fraction distribution. Talk with Harmon
