...
void noTreeSim(double *times, double *q12, double *q21, int *startState, long *seed, int *nState1, int *nState2, int *vezes, int *loops);
...
void noTreeSim(double *times, double *q12, double *q21, int *startState, long *seed, int *nState1, int *nState2, int *vezes, int *loops){
        int ch12, ch21, i, ns1, ns2, ntimes, start,loop;
	double wt, pij[4], prT1, rr;

        float _times[] = {'1.87','1.11','0.94','0.88','0.69','0.48','0.40'};
        loop = 0;
